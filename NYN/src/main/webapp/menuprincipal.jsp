...
<html>
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../style/img/imagen2.jpg" class="d-block  "  alt="imagen1"/>
                </div> 
                <div class="carousel-item">
                    <img src="../style/img/juane.jpg" class="d-block " alt="imagen2"/>
                </div>
                <div class="carousel-item">
                    <img src="../style/img/aventuraa_c.jpg" class="d-block " alt="imagen3"/>
                </div>
            </div>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <img src="../style/img/aventura.png" class="card-img-top" alt="imagen1"/>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="../style/img/morat.png" class="card-img-top" alt="imagen2"/>
                    <div class="card-body">
                        <h5 class="card-title">ESTADIO NACIONAL LIMA/MUSICA</h5>
